    ...
    <>
      ...
      drawerContent={(props) => <CustomDrawer {...props}  />}>
        ...
        <Drawer.Screen name="Chat" options={{headerShown:false}}>
          {() => <Livestream  navigation={navigation} isHost={true} UserId={userId} liveId={liveId} ReceuverId={37}/>}
        </Drawer.Screen>
        <Drawer.Screen name="ShowLivestream" options={{headerShown:false}}>
          {() => <AudienceStream  navigation={navigation} isHost={false} UserId={userId} liveId={liveId} ReceuverId={38}/>}
        </Drawer.Screen>
        <Drawer.Screen name="CustomLiveStream" options={{headerShown:false}}>
          {() => <CustomLiveStream  navigation={navigation}/>}
        </Drawer.Screen>
      </Drawer.Navigator>
